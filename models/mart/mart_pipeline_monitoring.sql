...
WITH model_row_counts AS (
    ...
    SELECT
        ...
        COUNT(*) AS row_count,
        MAX(CAST(order_date AS DATE)) AS latest_date,
    ...
    SELECT
        ...
        COUNT(*),
        MAX(CAST(experiment_start_date AS DATE)),
        CURRENT_TIMESTAMP()
